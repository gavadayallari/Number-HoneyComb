...
function PreviewSidebar({
  ...
  return (
    <div
      className={`pointer-events-none do-no-capture fixed w-fit p-2 md:p-3 lg:p-4 top-0 left-0 bottom-0 flex items-start z-10 transition-all duration-300 ${
      ...
      <div className="h-full flex flex-col items-center gap-6">
        ...
        {!isPlaying && (
          <>
            <button
              onClick={toggleMute}
              className={`pointer-events-auto md:size-12 size-10 lg:size-16 rounded-full ${
                isMuted
